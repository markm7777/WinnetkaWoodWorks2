...
//simple async/await test examples - call testStuff() from somewhere
...
// function testStuff() {
//   console.log('testStuff 1');

//   let returnVal = myAsyncFunc()
//   .then(res => {console.log('back in testStuff')})

//   console.log('testStuff 2');
// }


class Login extends React.Component {
  //props -> title, loggedIn, openLogin(), openLogout()
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <p id='login' onClick={this.props.loggedIn ? this.openLogout : this.props.openLogin}>{this.props.title}</p>
      </React.Fragment>
    )
  }
}
...
class ShoppingCart extends React.Component {
  //props -> title, openShoppingCart(), icon, cartCount
...
class Checkout extends React.Component {
  //props -> title, openCheckout(), enable
...
class LogInDialog extends React.Component {
  //props ->  onLogin(), onCancel(), openRegister(), user, registerTitle, loginFailed
  constructor(props) {
    super(props);
...
//    testStuff(); //for testing async/await 
  }
...
class RegisterDialog extends React.Component {
  //props -> onRegister(), onCancelRegister()
  constructor(props) {
    super(props);
...
class ShoppingCartDialog extends React.Component {
  //props -> onOk(), onCancel(), user, cartItems, onRemoveItemFromCart(), onChangeQty(), onCheckoutFromCart(), subTotal
...
class CheckoutDialog extends React.Component {
  //props -> onCheckout(), onCancel(), user, cartItems
...
class ShippingAddress extends React.Component {
  //props -> onChange(), onShippingSameAsBilling, shipName, shipAddress, shipCity, shipState, shipZip, disable
  ...
  render() {
    return (
      <React.Fragment>
        <nav id="nav">
          <ul>
            <li className={'liNav no-bullet ' + (this.state.activeItem === 'Home' ? 'activeClass' : '')}><a onClick={() => this.changeArticle('Home')} >Home</a></li>
            <li className={'liNav no-bullet ' + (this.state.activeItem === 'Products' ? 'activeClass' : '')}><a onClick={() => this.changeArticle('Products')}>Products</a></li>
            <li className={'liNav no-bullet ' + (this.state.activeItem === 'About' ? 'activeClass' : '')}><a onClick={() => this.changeArticle('About')}>About</a></li>
            <li className={'liNav no-bullet ' + (this.state.activeItem === 'menu4' ? 'activeClass' : '')}><a onClick={() => this.changeArticle('Contact')}>Contact</a></li>
          </ul>
        </nav>
      </React.Fragment>
    )
...
function Home(props) {
  return (
    <div id='homeDiv'>
      {props.videoEnded && <div id='imgDiv1'> <img src='chair.jpg' alt="Pineapple" style={{width:'200px', height:'200px'}}></img> </div>} 
      {props.videoEnded && <div id='imgDiv2'> <img src='lamp.JPG' alt="Pineapple" style={{width:'200px', height:'200px'}}></img> </div>} 
      {props.videoEnded && <div id='imgDiv3'> <img src='bench.JPG' alt="Pineapple" style={{width:'200px', height:'200px'}}></img> </div>} 
      {props.videoEnded && <div id='imgDiv4'> <img src='headboard.JPG' alt="Pineapple" style={{width:'300px', height:'300px'}}></img> </div>} 
    </div>
  )
}
  ...
  return(
    <div id='aboutDiv'>
      <p className="subhead" style={{marginLeft: '30px', marginRight: '40px', marginTop: '0px', textIndent: '20px', opacity: '1.0', color: 'black'}}>
        <img src='logo5.png' alt="Pineapple" style={{width:'100px', height:'100px', marginLeft: '10px', marginRight: '20px', float: 'left'}}></img>
        ...
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        <img src='shed1.JPG' alt="shed" style={{width:'200px', height:'200px', marginLeft: '10px', marginRight: '20px', marginTop: '10px', marginBottom: '10px', float: 'right'}}></img>
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
      ...
      <p style={{textIndent: '20px', marginLeft: '30px', marginRight: '40px', color: 'black'}}>At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        ...
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        <img src='sv650.jpg' alt="motorcycle" style={{width:'200px', height:'200px', marginLeft: '10px', marginRight: '20px', marginTop: '10px', marginBottom: '10px', float: 'left'}}></img>
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
        At Winnetka Woodworks we strive to produce quality furniture that will provide a lifetime of enjoyment.
...
function Contact(props) {
  ...
  return(
    ...
    <div id='contactDiv'>
        ...
        <a>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26395.913036501577!2d-118.58849713338948!3d34.210527146292364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c29bf24b78f7d1%3A0x641ef7caae4314da!2sWinnetka%2C%20Los%20Angeles%2C%20CA!5e0!3m2!1sen!2sus!4v1577414854081!5m2!1sen!2sus" style={{width:"900", height:"750", frameBorder:"0", border: "0", allowFullScreen:""}}></iframe>
        </a>
    </div>
    </>
  )
      ...
      <div id="outerDiv-x">
        <div id='headerDiv-x'>
          ...
          <div id='headerLinks'>  
            ...
            <ShoppingCart title={'Shopping Cart'} openShoppingCart={this.openShoppingCart} icon={'./icons8-shopping-cart-30.png'} cartCount={this.state.cartCount}></ShoppingCart>
